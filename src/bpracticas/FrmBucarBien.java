...
public class FrmBucarBien extends javax.swing.JDialog {
    ...
    public static String vnomb  = "";
    public static String vapell  = "";
    ...
    private void tKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ESCAPE)
        {
            ...
            vnomb = txtDescripcion.getText();
            vapell = txtApellido.getText();
            dispose();
        }
    ...
    private void tKeyReleased(java.awt.event.KeyEvent evt) {                              
       ...
       txtApellido.setText(String.valueOf(this.t.getValueAt(posreg,2)));
    }                             
    ...
    private void porteclado(KeyEvent evt){
       ...
       private void  filtrarGrilla()
       {
        ...
        try
        {
            ...
            conn.rs = conn.snt.executeQuery(
                    "SELECT id, nombre, apellido FROM autores where nombre like '%"+txtNombre.getText()+
                    "%' or apellido like '%"+txtNombre.getText()+"%'");
           
           while(conn.rs.next())
            {
               m.addRow(new Object[]{conn.rs.getInt("id"), 
                          conn.rs.getString("nombre"),
                          conn.rs.getString("apellido")
               });
    ...
    private void cargarGrilla(){
        ...
        {
            conn.snt = conn.con.createStatement();
            conn.rs =conn.snt.executeQuery("SELECT id, nombre, apllido FROM autores");
            while(conn.rs.next()){
                      m.addRow(new Object[]{conn.rs.getInt("id"),
                          conn.rs.getString("nombre"),
                          conn.rs.getString("apellido")
